...
**Posljednje ažurirano:** 18. listopada 2025.
...
public class Zivotinja {
    ...
    // Metoda koju će podklase nadjačati
...
- nadjačavaju (`@Override`) metodu `opisZvuka()` da bi imale specifično ponašanje
- `super(ime)` u konstruktoru poziva konstruktor roditelja `Zivotinja`
...
public class Main {
    public static void main(String[] args) {
        // Varijable tipa Zivotinja, ali stvarni objekti su Pas i Macka
        ...
        for (Zivotinja z : zivotinje) {
            System.out.println(z.napraviZvuk());
        }
    }
}
```
...
- **Metode:**
    - `dodajSportasa(String ime, int godine, String tip)` – **kompozicija**, stvara sportaša prema tipu i dodaje u listu.
    - `dodajSportasa(Sportaš s)` – **agregacija**, dodaje već postojećeg sportaša u listu.
...
- U `main` metodi:
    ...
    3. Dodaj sportaše u timove, barem jednu metodu kompozicijom i jednu agregacijom.
    4. Pozovi metode za ispis svih sportaša po timovima i po klubu.

**Primjer:**

```
Tim: Plivački tim
Ime: Ana, Godine: 20, Ana pliva.
Ime: Ivan, Godine: 22, Ivan pliva.

Tim: Nogometni tim
Ime: Marko, Godine: 21, Marko igra nogomet.
Ime: Luka, Godine: 23, Luka igra nogomet.
```
...
> Ako modifikator nije naveden, podrazumijeva se da je `public`
